package com.rainbow.gray.framework.constant;
...
public class ConfigConstant {
    ...
    public static final String VERSION_ELEMENT_NAME = GrayConstant.VERSION;
    public static final String REGION_ELEMENT_NAME = GrayConstant.REGION;
    public static final String ADDRESS_ELEMENT_NAME = GrayConstant.ADDRESS;
    public static final String VERSION_WEIGHT_ELEMENT_NAME = GrayConstant.VERSION_WEIGHT;
    public static final String REGION_WEIGHT_ELEMENT_NAME = GrayConstant.REGION_WEIGHT;
