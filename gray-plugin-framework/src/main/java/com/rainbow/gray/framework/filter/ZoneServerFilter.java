...
public class ZoneServerFilter extends AbstractServerFilter {
    @Value("${" + GrayConstant.SPRING_APPLICATION_ZONE_ROUTE_ENABLED + ":true}")
    ...
    private void applyZoneFilter(String providerServiceId, List<ServiceInstance> instances) {
        ...
        if (StringUtils.equals(zone, GrayConstant.DEFAULT)) {
            return;
        }
